...
export default {
    ...
    created() {
        // 注册收到数据的回调函数
        this.$socket.registerCallBack('fullScreen', this.recevieData)
        this.$socket.registerCallBack('themeChange', this.recvThemeChange)
    },
    destroyed() {
        this.$socket.unRegisterCallBack('fullScreen', this.recevieData)
        this.$socket.unRegisterCallBack('themeChange', this.recvThemeChange)
    },
    computed: {
        // logoSrc() {
        //     return '../img' + getThemeValue(this.theme).logoSrc
        // },
        headerSrc() {
            return '/img/' + getThemeValue(this.theme).headerBorderSrc
        },
        themeSrc() {
            return '/img/' + getThemeValue(this.theme).themeSrc
        },
        containerStyle() {
            return {
